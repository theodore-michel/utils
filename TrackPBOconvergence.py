...
ax.set_xticks(np.arange(0, EPISODES, 5))
...
axs[0, 0].plot(EpEnvAxis, A1, color = colors[0], linewidth=0.4, label='Theta_1')
# axs[0, 0].set_title('Theta_1')
axs[0, 1].plot(EpEnvAxis, A2, color = colors[0], linewidth=0.4, label='Theta_2')
# axs[0, 1].set_title('Theta_2')
axs[1, 0].plot(EpEnvAxis, A3, color = colors[0], linewidth=0.4, label='Theta_3')
# axs[1, 0].set_title('Theta_3')
axs[1, 1].plot(EpEnvAxis, A4, color = colors[0], linewidth=0.4, label='Theta_4')
# axs[1, 1].set_title('Theta_4')
axs[2, 0].plot(EpEnvAxis, A5, color = colors[0], linewidth=0.4, label='Theta_5')
# axs[2, 0].set_title('Theta_5')
axs[2, 1].plot(EpEnvAxis, A6, color = colors[0], linewidth=0.4, label='Theta_6')
# axs[2, 1].set_title('Theta_6')
x_ticks        = np.arange(0,EPISODES*ENV+1,80)
...
for axss in axs.flat:
    ...
    axss.tick_params(labelright=True, labelleft=True, left=True, right=True)
    axss.label_outer()
